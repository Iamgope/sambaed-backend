...
from users.models import ApplicationConfig, TopicComment, UserDevice, UserFeedback, UserProfile
...
def create_topic_comment(*, user: User, topic_id: int, comment: str, side: str) -> TopicComment:
