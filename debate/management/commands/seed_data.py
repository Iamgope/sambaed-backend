...
from debate.constants import DebateStatus, RoundType
...
SAMPLE_USERS = [
    {
        ...
        "debates": 45,
        "streak": 4,
        "bio": "Debate coach by day. Overthinker always.",
    },
    {
        "username": "dev_p",
        "first_name": "Dev",
        ...
        "debates": 33,
        "streak": 2,
        "bio": "Sports and policy nerd. BITS Pilani '22.",
    },
    {
        "username": "aisha_n",
        "first_name": "Aisha",
        ...
        "debates": 71,
        "streak": 9,
        "bio": "Reading more books than I can finish.",
    },
    {
        "username": "kabir_s",
        "first_name": "Kabir",
        ...
        "debates": 24,
        "streak": 0,
        "bio": "Law student. Probably biased.",
    },
    {
        "username": "priya_sh",
        "first_name": "Priya",
        ...
        "debates": 39,
        "streak": 3,
        "bio": "Philosophy + tech. Ask me about consciousness.",
    },
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if options["flush"]:
            ...
            User.objects.filter(
                username__in=[u["username"] for u in SAMPLE_USERS]
            ).delete()
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"  {len(cat_objs)} categories, {len(topic_objs)} topics"
            )
        )
        ...
        try:
            ...
            self.stdout.write(
                self.style.WARNING("  testuser not found — skipping profile")
            )
        ...
        if not User.objects.filter(username="testuser").exists():
            self.stdout.write(
                self.style.WARNING("  testuser missing — skipping debates")
            )
            return
        ...
        for title, pro, con, pro_wins, days_ago in debate_specs:
            ...
            for order, rtype in enumerate(round_types, 1):
                ...
                round_obj = Round.objects.create(
                    ...
                    order=order,
                    started_at=t,
                    ended_at=t + timedelta(minutes=6),
            ...
            Judgement.objects.create(
                debate=debate,
                winner=pro if pro_wins else con,
                argument_score_pro=arg_pro,
                rebuttal_score_pro=reb_pro,
                clarity_score_pro=cla_pro,
                persuasion_score_pro=per_pro,
                argument_score_con=arg_con,
                rebuttal_score_con=reb_con,
                clarity_score_con=cla_con,
                persuasion_score_con=per_con,
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"  {created_debates} debates with rounds, messages, and judgements"
            )
        )
