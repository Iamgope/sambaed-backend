...
class DebateAdmin(ModelAdmin):
    list_display = ('topic', 'user_pro', 'user_con', 'status', 'started_at', 'completed_at')
    list_filter = ('status',)
...
class RoundAdmin(ModelAdmin):
    ...
    search_fields = ('debate__topic__title', 'debate__user_pro__username', 'debate__user_con__username')
